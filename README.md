...
También incluye imágenes alternativas en las carpetas `imagenes` y `IMG`  en caso de que se desee personalizar la imagen principal del desarrollador, además de animación a la escritura de la página web con JavaScript.
